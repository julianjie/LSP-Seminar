...
<head>
    ...
    <title>@yield('title') - Sistem Pendaftaran Seminar LSP</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom py-3 sticky-top">
        <div class="container">
            <a class="navbar-brand text-white d-flex align-items-center" href="{{ route('welcome') }}">
                ...
                <span>SEMINAR<span class="text-warning">LSP</span></span>
            </a>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    <div class="d-flex align-items-center mb-2 justify-content-center justify-content-md-start">
                        ...
                        <span class="text-white fw-bold fs-5">SEMINAR<span class="text-warning">LSP</span></span>
                    </div>
                    <p class="small mb-0">Sistem Pendaftaran Seminar Sertifikasi LSP Pengembang Web.</p>
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <p class="small mb-0">&copy; {{ date('Y') }} LSP-UMDP. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
